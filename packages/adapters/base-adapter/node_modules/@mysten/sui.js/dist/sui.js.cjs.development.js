...
var RpcClient = _interopDefault(require('jayson/lib/client/browser'));
...
var Base64DataBuffer = /*#__PURE__*/function () {
  function Base64DataBuffer(data) {
    if (typeof data === 'string') {
      this.data = new Uint8Array(buffer.Buffer.from(data, 'base64'));
    } else {
      this.data = data;
    }
  }
  ...
  _proto.toString = function toString() {
    return buffer.Buffer.from(this.data).toString('base64');
  };
...
var PublicKey = /*#__PURE__*/function () {
  ...
  function PublicKey(value) {
    if (isPublicKeyData(value)) {
      ...
      if (typeof value === 'string') {
        var buffer$1 = buffer.Buffer.from(value, 'base64');

        if (buffer$1.length !== 32) {
          throw new Error("Invalid public key input. Expected 32 bytes, got " + buffer$1.length);
        }

        this._bn = new BN__default(buffer$1);
      } else {
  ...
  _proto.toBuffer = function toBuffer() {
    ...
    var zeroPad = buffer.Buffer.alloc(PUBLIC_KEY_SIZE);
  ...
  _proto.toSuiAddress = function toSuiAddress() {
    var hexHash = jsSha3.sha3_256(this.toBytes());
...
function isPublicKeyData$1(obj, _argumentName) {
  return (obj !== null && typeof obj === "object" || typeof obj === "function") && obj._bn instanceof BN.BN;
}
...
var HexDataBuffer = /*#__PURE__*/function () {
  function HexDataBuffer(data) {
    if (typeof data === 'string') {
      this._data = new Uint8Array(buffer.Buffer.from(data, 'hex'));
    } else {
      this._data = data;
    }
  }
  ...
  _proto.toString = function toString() {
    return buffer.Buffer.from(this._data).toString('hex');
  };
...
var Coin = /*#__PURE__*/function () {
  ...
  Coin.getBalance = function getBalance(data) {
    ...
    return new BN__default.BN(balance, 10);
  };

  Coin.getZero = function getZero() {
    return new BN__default.BN('0', 10);
  };
...
exports.getMergeCoinResponse = getMergeCoinResponse;
...
exports.getPublishResponse = getPublishResponse;
exports.getPublishTransaction = getPublishTransaction;
exports.getSplitCoinResponse = getSplitCoinResponse;
...
exports.getTransactionEffectsResponse = getTransactionEffectsResponse;
...
exports.isEd25519KeypairData = isEd25519KeypairData;
...
exports.isMergeCoinResponse = isMergeCoinResponse;
exports.isMergeCoinTransaction = isMergeCoinTransaction;
exports.isMoveCall = isMoveCall;
exports.isMoveCallTransaction = isMoveCallTransaction;
...
exports.isPublicKeyData = isPublicKeyData$1;
exports.isPublicKeyInitData = isPublicKeyInitData;
exports.isPublishResponse = isPublishResponse;
exports.isPublishTransaction = isPublishTransaction;
exports.isSequenceNumber = isSequenceNumber;
exports.isSignaturePubkeyPair = isSignaturePubkeyPair;
exports.isSigner = isSigner;
exports.isSplitCoinResponse = isSplitCoinResponse;
exports.isSplitCoinTransaction = isSplitCoinTransaction;
...
exports.isTransactionEffectsResponse = isTransactionEffectsResponse;
...
exports.isTransferObjectTransaction = isTransferObjectTransaction;
exports.isTxnDataSerializer = isTxnDataSerializer;
...
//# sourceMappingURL=sui.js.cjs.development.js.map
